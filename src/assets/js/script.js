...
$(document).ready(function() {
  $(".multi-text").on("keypress", function() {
    var text = $(".multi-text").val();
    var t = text.split(",");
    ...
    if (t.length > 1) {
      $(this)
        ...
        .prepend(
          '<li class="addedTag">' +
            t[0] +
            "<span onclick=\"$(this).parent().remove();removeFromList('" +
            t[0] +
...
$(document).ready(function() {
  $(".multi-text-cat").on("keypress", function() {
    var text = $(".multi-text-cat").val();
    var t = text.split(",");
    ...
    if (t.length > 1) {
      $(this)
        ...
        .prepend(
          '<li class="addedTag">' +
            t[0] +
            "<span onclick=\"$(this).parent().remove();removeCatFromList('" +
            t[0] +
            '\');" class="tagRemove">x</span></li>'
        );
      $("#categories").val($("#categories").val() + t[0] + ",");
      $(".multi-text-cat").val("");
    }
  });
});
